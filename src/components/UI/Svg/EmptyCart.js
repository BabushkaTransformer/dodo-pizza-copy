...
function EmptyCart(props) {
    return (
        <svg width={222} height={144} fill="none" {...props}>
            <path
            ...
            />
            <path
                d="M103.484 95.017c.247-1.55.099-3.002-1.823-4.653m6.258 4.352c.197-1.55.296-3.302-2.661-5.253"
                stroke="#000"
                strokeWidth={1.1}
                strokeMiterlimit={10}
                strokeLinecap="round"
            ...
            />
            <path
                d="M207.424 108.257c.468-1.149.196-2.355-.609-2.693-.804-.338-1.836.319-2.305 1.468-.468 1.149-.196 2.354.609 2.693.805.338 1.837-.319 2.305-1.468zm-56.738-92.246l-11.628 3.903 15.669 4.703c.591-1.901 6.109-1.901 12.367-.05 6.257 1.852 10.889 4.954 10.347 6.855l15.668 4.703 11.481-4.553-53.904-15.56z"
                fill="#fff"
                stroke="#000"
                strokeWidth={1.1}
                strokeMiterlimit={10}
            ...
            />
            <path
                d="M143.986 129.441l15.619-.2-.049 10.757-15.619.201.049-10.758zm73.071-22.666l-57.451 22.466-.049 10.757 57.5-22.866v-10.357z"
                fill="#fff"
                stroke="#000"
                strokeWidth={0.804}
                strokeMiterlimit={10}
            ...
            />
            <path
                d="M217.057 106.775l-57.451 22.466-.049 10.757 57.5-22.866v-10.357zm-73.071 22.666l15.619-.2-.049 10.757-15.619.201.049-10.758z"
                stroke="#000"
                strokeWidth={1.1}
                strokeMiterlimit={10}
                strokeLinecap="round"
            ...
            />
            <path
                d="M95.06 104.473l59.914-19.964-.049 10.758 48.187 16.961-43.506 17.012-15.62.2 1.626 2.852-57.007-22.065 4.582-.25 1.873-5.504zm0 0v10.608"
                stroke="#000"
                strokeWidth={1.1}
                strokeMiterlimit={10}
                strokeLinecap="round"
            ...
            />
            <path
                d="M97.917 35.376c.493.75 1.232 3.103.936 5.404.69-2.251.788-4.653 2.661-7.355-.789.8-3.597 1.951-3.597 1.951zm-10.051 1.45c-1.478.1-2.957-.35-4.188-1.05 3.202 1.75 4.385 5.653 7.44 7.454.049.05.098.05.197.1-1.922-1.9-1.725-5.303-3.45-6.504z"
                fill="#000"
            />
            <path
